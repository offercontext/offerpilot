...
def test_read_log_page_excludes_entries_appended_after_snapshot_count(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(diagnostics, "_count_valid_log_rows", count_then_append, raising=False)
...
def test_read_log_page_does_not_mix_a_rotated_file_after_snapshot_count(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(diagnostics, "_count_valid_log_rows", count_then_rotate, raising=False)
    monkeypatch.setattr(diagnostics, "_open_log_file", open_rotating_log, raising=False)
...
def test_read_log_page_retains_only_the_requested_page(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(diagnostics, "_append_page_entry", track_retained_entry, raising=False)
